...
namespace IMPULS.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class TestEmpresaGestioOfertes
    {
        ...
        /// </summary>
        [TestMethod]
        public async Task EmpresaConsultaOfertes()
        {
        ...
        /// </summary>
        [TestMethod]
        public async Task EmpresaModificaOfertes()
        {
        ...
        /// </summary>
        [TestMethod]
        public async Task EmpresaEliminaOfertes()
        {
